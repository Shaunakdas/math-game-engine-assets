...
public class CommonTestController : MonoBehaviour {

	public static readonly string domain = "localhost:3000";
	CommonQAViewController qAObject;
	string getQAListJSONText,postQAAttemptText;
	// Use this for initialization
	void Start () {
		qAObject = (CommonQAViewController) gameObject.GetComponent(typeof(CommonQAViewController));
