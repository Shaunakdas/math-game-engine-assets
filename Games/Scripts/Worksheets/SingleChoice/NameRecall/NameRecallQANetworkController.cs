...
using System.Linq;
using SimpleJSON;
public class NameRecallQANetworkController : MonoBehaviour {

	public static readonly string domain = "localhost:3000";
	NameRecallQAViewController commonQAViewCtrl;
	...
	IEnumerator getQAListNetworkCall(QuesAnsList quesAnsList) {
		commonQAViewCtrl = (NameRecallQAViewController) gameObject.GetComponent(typeof(NameRecallQAViewController));;
